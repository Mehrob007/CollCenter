    ...
    try {
      ...
      if (token) {
        const response = await apiClient.get(
          `/api/users/get-extension-secret`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  return (
    <div className="CollBox">
          ...
          return (
            <>
              <div className="btnCallinBack">
                <Button
                  onClick={accept}
                  style={{ background: "#0CD939" }}
                  className="callinBack"
                >
                ...
                <Button
                  onClick={decline}
                  style={{ background: "#D90C0C", margin: 0 }}
                  className="callinBack"
                >
      ...
      <div className="collPanel">
        ...
        <p style={{ opacity: !isActive ? 0 : 1 }}>{`${
          seconds < 600 ? "0" : ""
        }${Math.floor((seconds % 3600) / 60)}:${seconds < 10 ? "0" : ""}${
          seconds % 60
        }`}</p>
        <input
          type="text"
        ...
        <div className="Nambers">
          <button onClick={() => funNanbersBtn(1)} className="number">
            1
          </button>
          <button onClick={() => funNanbersBtn(2)} className="number">
            2
          </button>
          <button onClick={() => funNanbersBtn(3)} className="number">
            3
          </button>
          <button onClick={() => funNanbersBtn(4)} className="number">
            4
          </button>
          <button onClick={() => funNanbersBtn(5)} className="number">
            5
          </button>
          <button onClick={() => funNanbersBtn(6)} className="number">
            6
          </button>
          <button onClick={() => funNanbersBtn(7)} className="number">
            7
          </button>
          <button onClick={() => funNanbersBtn(8)} className="number">
            8
          </button>
          <button onClick={() => funNanbersBtn(9)} className="number">
            9
          </button>
          <button onClick={() => funNanbersBtn("*")} className="number">
            *
          </button>
          <button onClick={() => funNanbersBtn(0)} className="number">
            0
          </button>
          <button onClick={() => funNanbersBtn("#")} className="number">
            #
          ...
          <button onClick={() => perenCall()}>
            <SlCallOut
              style={{ color: "#000", fontSize: "30px", fontWeight: "600" }}
            />
          </button>
        </div>
      </div>
